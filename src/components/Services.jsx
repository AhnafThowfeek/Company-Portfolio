...
const Services = () => {
    const services = [
        {id:1, title: "Web Development", descroption: "WordPress Webkite Development (CMS)"},
        {id:2, title: "Graphic Designing", descroption:<ul className="list-disc list-inside text-left">
            <li>Flyer Design</li>
        ...
        {id:3, title: "Infographic Design", descroption:<ul className="list-disc list-inside text-left">
  ...
  return (
    ...
    <div className='md:px-14 px-4 py-16 max-w-screen-2xl mx-auto' id='services'>
        ...
        <div className='mt-14 grid lg:grid-cols-3 md:grid-cols-2 grid-cols-1 md:w-11/12 mx-auto gap-12 '>
            {
                services.map(service => <div key={service.id} className='px-4 py-8 text-center md:w-[300px] mx-auto md:h-80 rounded-md shadow cursor-pointer  hover:border-b-4 hover:border-sky-600  duration-300 flex items-center justify-center h-full'>
                    <div>
